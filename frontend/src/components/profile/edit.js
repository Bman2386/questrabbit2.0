            ...
            <div className='box'>
                <div className='width'>
                    ...
                    <div className='edit-user'>
                        ...
                        <button  id='btn' onClick={()=> setEditItem('username')}>Change Username</button>}
                        ...
                        <button  id='btn' onClick={()=> setEditItem('Family Crest')}>Change Family Crest</button>}
                        <label className='p2'>Realm: {realm}</label>
                        {editItem === 'Realm' ? <InputField setItem={setRealm} item={realm}/> : 
                            <button  id='btn' onClick={()=> setEditItem('Realm')}>Change Realm</button>}
                        <label className='p2'>Star Sign: {starSign}</label>
                        {editItem === 'Star Sign' ? <InputField setItem={setStarSign} item={starSign}/>:
                            <button  id='btn' onClick={()=>setEditItem('Star Sign')}>Change Star Sign</button>}
                    </div>
